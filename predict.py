...
crop_colors = {
    "rice": "rgba(240, 255, 240, 0.5)",         # Honeydew
    "maize": "rgba(255, 228, 181, 0.5)",        # Moccasin
    "chickpea": "rgba(255, 239, 213, 0.5)",     # Papaya Whip
    "kidneybeans": "rgba(255, 182, 193, 0.5)",  # Light Pink
    "pigeonpeas": "rgba(255, 248, 220, 0.5)",   # Cornsilk
    "mothbeans": "rgba(230, 230, 250, 0.5)",    # Lavender
    "mungbean": "rgba(152, 251, 152, 0.5)",     # Pale Green
    "blackgram": "rgba(176, 224, 230, 0.5)",    # Powder Blue
    "lentil": "rgba(255, 228, 196, 0.5)",       # Bisque
    "pomegranate": "rgba(255, 160, 122, 0.5)",  # Light Salmon
    "banana": "rgba(255, 250, 205, 0.5)",       # Lemon Chiffon
    "mango": "rgba(255, 218, 185, 0.5)",        # Peach Puff
    "grapes": "rgba(216, 191, 216, 0.5)",       # Thistle
    "watermelon": "rgba(240, 128, 128, 0.5)",   # Light Coral
    "muskmelon": "rgba(255, 222, 173, 0.5)",    # Navajo White
    "apple": "rgba(250, 128, 114, 0.5)",        # Salmon
    "orange": "rgba(255, 165, 0, 0.5)",         # Orange
    "papaya": "rgba(144, 238, 144, 0.5)",       # Light Green
    "coconut": "rgba(245, 222, 179, 0.5)",      # Wheat
    "cotton": "rgba(255, 228, 225, 0.5)",       # Misty Rose
    "jute": "rgba(210, 180, 140, 0.5)",         # Tan
    "coffee": "rgba(139, 69, 19, 0.5)",         # Saddle Brown
}
